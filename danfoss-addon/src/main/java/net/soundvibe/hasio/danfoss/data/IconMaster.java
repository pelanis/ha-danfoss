...
public record IconMaster(
    ...
    public State toState() {
        return new State(Instant.now().toString(), Map.ofEntries(
                ...
                entry("house_name", houseName != null ? houseName : "Unknown"),
                entry("pause_set_point", String.valueOf(pauseSetPoint)),
                entry("vacation_set_point", String.valueOf(vacationSetPoint)),
                entry("hardware_revision", hardwareRevision != null ? hardwareRevision : "Unknown"),
                entry("software_revision", softwareRevision != null ? softwareRevision : "Unknown"),
                entry("serial_number", serialNumber != null ? serialNumber : "Unknown"),
                entry("software_build_revision", String.valueOf(softwareBuildRevision)),
                entry("connection_count", String.valueOf(connectionCount)),
                entry("production_date", productionDate != null ? productionDate.toString() : "Unknown")
        ));
    }
